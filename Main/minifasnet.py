...
from torch.nn import Linear, Conv2d, BatchNorm1d, BatchNorm2d, PReLU, ReLU, Sigmoid, AdaptiveAvgPool2d, Sequential, Module

# --- 1. Define Model Architecture (MiniFASNetV2) ---
...
def load_model(weights_path):
    # Detect kernel size from weights
    try:
        ...
        kernel_size = (7, 7)
        if 'conv_6_dw.conv.weight' in new_state_dict:
            s = new_state_dict['conv_6_dw.conv.weight'].shape
            if s[2] != 7 or s[3] != 7:
                 kernel_size = (s[2], s[3])
